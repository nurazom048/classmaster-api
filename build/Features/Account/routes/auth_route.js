...
// 1
app.post("/create", account_middleware_1.validateAccountCreation, auth_controllers_1.createAccount);
app.post("/login", auth_controllers_1.loginAccount);
//app.delete("/delete/:id", verifyToken, deleteAccount);
// continued with goglet
app.post("/google", auth_middleware_1.verifyGoogleAuthToken, google_auth_controller_1.continueWithGoogle);
// pending
