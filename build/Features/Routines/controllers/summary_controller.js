...
const socket_server_1 = require("../../../socket.server"); // Import Socket.IO instance
...
const addSummary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const summaryDataWithOwner = yield prisma_clint_1.default.summary.findUnique({
        ...
        if (summaryDataWithOwner) {
            socket_server_1.io.to(`routine-${routineID}`).emit('summary:created', summaryDataWithOwner);
        }
...
const removeSummary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.findSummary && req.findSummary.routineId) {
            socket_server_1.io.to(`routine-${req.findSummary.routineId}`).emit('summary:deleted', {
                summaryID: summaryID,
