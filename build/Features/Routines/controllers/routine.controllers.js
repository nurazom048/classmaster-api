...
exports.homeFeed = exports.current_user_status = exports.save_routines = exports.save_and_unsave_routine = exports.searchRoutine = exports.deleteRoutineById = exports.createRoutine = void 0;
// Models
...
const createRoutine = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { name } = req.body;
    const ownerId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id; // Ensure `req.user` is populated with authenticated user details
    if (!name || !ownerId) {
    ...
    try {
        ...
        const result = yield prisma_clint_1.default.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const existingRoutine = yield prisma.routine.findFirst({
                where: {
                    routineName: name,
            ...
            const createdRoutine = yield prisma.routine.create({
                data: {
                    routineName: name,
                    routineOwner: {
                        connect: { id: ownerId },
            ...
            const routineMember = yield prisma.routineMember.create({
                data: {
            ...
            const updatedUser = yield prisma.account.update({
                where: { id: ownerId },
                data: {
...
//--------------------------------- deleteRoutine  ------------------------------/
//*******************************************************************************/
const deleteRoutineById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        const result = yield prisma_clint_1.default.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield prisma.routineMember.deleteMany({
                where: {
                    routineId: existingRoutine.id,
                },
            });
            // Step 3: Delete the routine
            const deletedRoutine = yield prisma.routine.delete({
        ...
        yield (0, routines_firebase_1.deleteRoutineMediaFolder)(routineID);
        // If transaction completes successfully
        res.status(200).json({
...
//--------------------------------- search Routine  ------------------------------/
//*******************************************************************************/
const searchRoutine = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const count = yield prisma_clint_1.default.routine.count({
            where: {
                OR: [
        ...
        const routines = yield prisma_clint_1.default.routine.findMany({
            where: {
                OR: [
                    { routineName: { contains: src, mode: 'insensitive' } },
                    {
...
exports.searchRoutine = searchRoutine;
//***************************************************************************************/
...
const save_and_unsave_routine = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [routine, isSaved] = yield Promise.all([
            prisma_clint_1.default.routine.findUnique({ where: { id: routineId } }),
            prisma_clint_1.default.account.findFirst({ where: { id: userId, savedRoutines: { some: { id: routineId } } } })
        ]);
        if (!routine)
...
const current_user_status = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const savedRoutine = yield prisma_clint_1.default.account.findUnique({
            where: { id },
            select: {
                savedRoutines: {
        ...
        const pendingRequest = yield prisma_clint_1.default.routinesJoinRequest.findFirst({
            where: {
                routineId,
                accountIdBy: id,
            },
...
const homeFeed = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const joinedRoutineIds = yield prisma_clint_1.default.routineMember.findMany({
        ...
        const totalCount = yield prisma_clint_1.default.routine.count({
            where: userID
