...
import { edit_account, changePassword, forgetPassword, view_my_account, viewOthersAccount, searchAccounts } from "../controllers/account_controllers";
...
//**********************************************************************************************/
//... Edit account....///
router.post("/edit", verifyToken, upload.fields([{ name: 'coverImage', maxCount: 1 }, { name: 'image', maxCount: 1 }]), edit_account);
